...
def example_control_file():
    ...
    # Example format
    data = ('*PROJECT_NAME test project 101 \n'
...
class TestControlFile(unittest.TestCase):
    ...
    def test_slice_control_file_data(self):
        ...
        for i in range(len(logger_id_lines)):
            if i < len(logger_id_lines) - 1:
                logger_id_data.append(self.test_data[logger_id_lines[i]:logger_id_lines[i + 1]])
            else:
    ...
    def test_logger_properties_correctly_set(self):
        ...
        self.assertEqual(logger0.stats_cols, [1, 2, 3, 4])
        ...
        self.assertEqual(logger1.stats_cols, [1, 2, 3, 4])
